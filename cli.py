...
def run_training(rank, world_size, model_args, data, load_from, new, num_train_steps, name, seed, dataset_name=None):
    ...
    wandb.init(project="ProstateCa", entity="visual-intelligence-laboratory", name="ProjectedExv1-FFHQ")
...
def train_from_folder(
        data='/code/ProstateCa/ProjectedEx/data/Kaggle_FFHQ_Resized_256px',
        results_dir='./results',
        models_dir='./models',
        name='FFHQ',  # Name of the experiment.
        new=False,
        load_from=-1,
        image_size=64,
        ...
        classifier_path="/code/ProstateCa/asset/v1/resnet-18-64px-gender-classifier.pt",
